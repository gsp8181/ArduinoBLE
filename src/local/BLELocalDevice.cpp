...
void BLELocalDevice::setServiceData(const uint16_t serviceDataUuid, const uint8_t serviceData[], int serviceDataLength)
{
  GAP.setAdvertisedServiceData(serviceDataUuid, serviceData, serviceDataLength);
}
